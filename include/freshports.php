...
";
	...
	$HTML .= '<span class="amazon">Want a good monitor light? See my <a href="https://dan.langille.org/2023/12/30/blatant-self-interest-monitor-light/">photos</a></span>';
...
function freshports_LinkToDate($Date, $Text = '', $BranchName = BRANCH_HEAD) {
	$URL = '<a href="/date.php?date=' . date("Y/m/d", $Date);
	if ($BranchName != BRANCH_HEAD) {
