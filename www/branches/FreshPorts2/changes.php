...
<ul>
   ...
   <a href="ports-deleted.php">deleted ports page</a> and not the
   <a href="ports-new.php">new ports page</a>. Did any of you notice?</li>
...
<ul>
  <li>Added a <a href="ports-deleted.php">deleted ports page</a>.</li>
...
<ul>
  <li>Added a simple <a href="search.php">search</a> screen.</li>
