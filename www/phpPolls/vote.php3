...
<table width="600" border="0" cellpadding="3">
  <tr>
    <td class="vtop" width="100%"><h3>This is a quick test of the voting interface for the poll #<?php echo $pollID; ?></h3>
    ...
    be redirected to the url $poll_forwarder which in this case is &quot;<?php echo($url); ?>&quot;.
    &nbsp; The production site will forward each visitor to the page displaying poll results.</p>
    <p>&nbsp;</td>
    <td class="vtop"><table border="1" cellspacing="0">
      <tr>
        <td bgcolor="#C0C0C0" class="vcentered"><b>Quick Poll</b></td>
      </tr>
      <tr>
        <td nowrap>
<?php poll_generateUI($pollID, $url);?>
        </td>
      </tr>
    </table>
    </td>
